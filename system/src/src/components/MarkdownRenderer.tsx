    ...
    return (
        <ReactMarkdown
            ...
            components={{
                ...
                blockquote({ children }) {
                    // Start Agent Log Styling
                    return (
                        <div className="my-4 pl-4 border-l-4 border-indigo-500/50 bg-[var(--card)]/30 rounded-r-lg p-3 text-sm italic text-[var(--muted-foreground)]">
                            <div className="flex items-center gap-2 mb-1 not-italic">
                                <span className="font-semibold text-xs text-indigo-400">Agent Log</span>
                            </div>
                            {children}
                        </div>
                    );
